                ...
                <div class="table-responsive">
                    <table class="table table-borderless table-hover table-centered m-0">
                        ...
                        <tr>
                            ...
                            <td>
                                <h5 class="m-0 font-weight-normal">Simon Demeyere</h5>
                                <p class="mb-0 text-muted"><small>Member Since 2020</small></p>
                            </td>

                            <td>
                                <i class="mdi mdi-currency-btc text-primary"></i> EUR
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <h5 class="m-0 font-weight-normal">Henri-Tom Herman</h5>
                                <p class="mb-0 text-muted"><small>Member Since 1998</small></p>
                            </td>

                            <td>
                                <i class="mdi mdi-currency-eth text-primary"></i> EUR
                            </td>
