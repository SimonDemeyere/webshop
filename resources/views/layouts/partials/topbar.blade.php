...
<div class="navbar-custom">
    <ul class="list-unstyled topnav-menu float-right mb-0">
        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                @if(Auth::user()->photo)
                <img src="{{ asset('/assets/' . Auth::user()->photo->src) }}" alt="user-image" class="rounded-circle">
                @endif
    ...
    <div class="logo-box">
        <a href="/admin" class="logo text-center">
            ...
            <span class="logo-sm">
                ...
                <img src="{{ asset('assets/images/users/logo-sm.png') }}" alt="" height="24">
            </span>
        </a>
    </div>
    ...
    <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
        ...
        <li class="dropdown dropdown-mega d-none d-lg-block">
            <a class="nav-link waves-effect waves-light" href="/" target="_blank" role="button" aria-haspopup="false" aria-expanded="false">
                Open webshop
            </a>
        </li>
